...
-   [Taiga](https://taiga.io/). Taiga is our preferred project management solution we use it to track the progress of projects and it helps everyone keep track of the tasks that are done and need to be done next. Taiga is completely free and open-source. You can read our guide to the usage of Taiga [here](https://xamkfi.github.io/Koodariverstas-wikiplatform/articles/General/Taiga.html).
