...
date: "25.9.2024" ## date and time format is MM.DD.YYYY
author: Author/authors of the article. 
---
```

The wiki supports full markdown/html and lets you have total control over the content of your article. We recommend using a simple markdown editor such as [stackedit](https://stackedit.io/). The orange area in the image shown below is your "article" section. This section **has to include the metadata at the top of the section for the article (Otherwise your article WILL NOT be indexed and won't be rendered to the wiki)!** After you have included the metadata section, you are free to write and format whatever you wish in the main article.
