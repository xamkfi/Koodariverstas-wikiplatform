...
\[This is the detailed work plan how the project will actually meet it's objectives. Which tools, technologies, etc. It uses. How and by whom the testing is done and so on...\]
...
-   This document will be updated and re-approved if necessary (if there is major changes)
